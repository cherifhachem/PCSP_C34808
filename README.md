...
│   └── test_preprocessing.py   # Test pytest de reproductibilité
│
...
Une fonction fondamentale nommée `split_and_scale()` a été développée afin de préparer les données destinées aux futurs modèles d’Intelligence Artificielle.
...
2. appelle `split_and_scale()` deux fois
